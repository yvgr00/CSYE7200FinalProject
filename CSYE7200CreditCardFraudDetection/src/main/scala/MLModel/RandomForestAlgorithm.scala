...
object RandomForestAlgorithm {
  ...
  def main(args: Array[String]): Unit = {
   ...
   /* trainingData.coalesce(1)
      .write.format("com.databricks.spark.csv")
      .option("header", "true")
      .save("src/main/resources/traindata.csv")

    testData.coalesce(1)
      .write.format("com.databricks.spark.csv")
      .option("header", "true")
      .save("src/main/resources/testdata.csv") */
    ...
    //tunedModel.write.overwrite().save("src/main/scala/MLModel/RFModel")
