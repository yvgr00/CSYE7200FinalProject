...
object RandomForestAlgorithm {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val creditDS = spark
      ...
      .csv("C:\\Users\\venu0\\Downloads\\creditcard.csv\\creditcard.csv")
      .as[Credit]
    ...
    tunedModel.write.overwrite().save("D:\\BIGDATASCALA\\Assignments\\CSYE7200\\Credit Card Fraud Detection\\src\\main\\scala\\SparkMLModel\\RFModel")
